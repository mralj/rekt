use google_sheets4::oauth2::{
    self, ApplicationSecret, ServiceAccountAuthenticator, ServiceAccountKey,
};
...
fn get_secret() -> ServiceAccountKey {
    ...
    // ApplicationSecret {
    //     client_id: "115940951748583473356".into(),
    //     client_email: Some("nikola@stellar-utility-379116.iam.gserviceaccount.com".into()),
    //     client_secret: "92c8db4b9ef724bae2c876e07c166d9bba2eb734".into(),
    //     token_uri: "https://oauth2.googleapis.com/token".into(),
